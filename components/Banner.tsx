...
function Banner() {
  return (
    <div className='bg-[#d73a3a] w-screen h-[53vh] md:h-[55vh] lg:h-[95vh] lg:flex lg:flex-col lg:justify-start lg:items-center'>
        <Navbar />
        ...
        <p className='text-[#ddcfcf] text-center uppercase w-screen text-6xl font-bold ml-0 md:pt-8'>Poultry <span className='text-4xl'>Farm</span></p>
    </div>
  )
}
